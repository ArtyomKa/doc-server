...
description: |
  Complete 4-phase development workflow orchestrator with isolated subagents and human approval gates.
  
  Automates development phases: alignment verification, implementation with branch isolation,
  acceptance criteria verification, and commit workflow. Each phase runs in separate
  isolated context with specialist delegation and human approval gates.

  Use this skill to:
  - Start new development phases with "I'm going to start implementation of phase X.Y"
  - Progress through phases with human approvals: "proceed to implementation/verification/commit"
  - Track workflow status and session history
  - Coordinate specialist delegation (@explorer, @librarian, @oracle, @fixer, @designer)
...
# Dependencies for the skill implementation
dependencies:
  - typescript: ^5.0.0
  - zod: ^3.22.0
  - yaml: ^2.3.0
